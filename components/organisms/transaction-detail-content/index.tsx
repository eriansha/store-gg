...
export default function TranscationDetailContent() {
  return (
          ...
          <div className="main-content main-content-card overflow-auto">
            <section className="checkout mx-auto">
              ...
              <div className="purchase pt-30">
                ...
                <Row label='Ordder ID' value='#GG001' />
                <Row label='Item' value='250 Diamonds' />
                <Row label='Price' value='Rp42.280.500' />
                <Row label='Tax (10%)' value='Rp4.228.000' />
                <Row label='Total' value='Rp55.000.600' isSummary />
              </div>
